	...
	<cffunction name = "getOrderHistory" returntype = "query" access = "public" hint = "accessing order history of customer" >
		...
		<cftry>
			<cfquery name = "local.getOrderHistory" >
				SELECT T.TRANSACTIONNUMBER , T.DATE , O.ORDERITEMS , O.ORDERTOTALCOST , PWS.IMAGEURL , PWS.SHIPPINGPRICE , P.PRODUCTNAME , S.SELLERNAME , (O.ORDERITEMS * ( PWS.PRICE + PWS.SHIPPINGPRICE )) AS TOTALPRICE
